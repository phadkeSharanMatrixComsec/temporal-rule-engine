...
[Workflow]
public class RecordingStoppedEventWorkflow
{
    ...
    public async Task<string> StartWorkflow(List<string> actions)
    {
        ...
        Console.WriteLine("Listening for event", nameof(RecordingStoppedEventWorkflow));
    ...
    [WorkflowSignal]
    public async Task RecordingStoppedSignal(EventModel eventModel)
    {
